...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x8; // addresses start with "2"
...
const uint64_t DIFFICULTY_TARGET                             = 65; // seconds
...
const char     CRYPTONOTE_NAME[]                             = "MasterCoin";
